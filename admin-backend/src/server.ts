...
import employeeReceiptRoutes from './routes/employeeReceipt';
...
import centerAccessRoutes from './routes/centerAccess';
...
app.use('/api/workflow',       requireAuth('center_admin','hq_admin','super_admin'), workflowRoutes);
app.use('/api/payments',       financeInsightsRoutes);
app.use('/api/payments',       requireAuth('hq_admin','finance','finance_head','super_admin'), paymentRoutes);
...
app.use('/api/dashboard',      requireAuth('hq_admin', 'super_admin'), dashboardRoutes);
app.use('/api/requests',       requireAuth('employee', 'hq_admin', 'super_admin'), requestRoutes);
app.use('/api/inventory',      requireAuth('employee', 'hq_admin', 'center_admin', 'verifier', 'finance', 'finance_head', 'super_admin'), inventoryRoutes);
app.use('/api/admin/users',    requireAuth('hq_admin'), centerAccessRoutes);
app.use('/api/admin/users',    requireAuth('hq_admin'), usersRoutes);
app.use('/api/admin',          requireAuth('hq_admin'), adminRoutes);
app.use('/api/employee',       requireAuth('employee'), employeeRoutes);
app.use('/api/employee',       requireAuth('employee'), employeeReceiptRoutes);
app.use('/api/verifier',       requireAuth('verifier'), verifierRoutes);
app.use('/api/super-admin/users', requireAuth('super_admin'), centerAccessRoutes);
